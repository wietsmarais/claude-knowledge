...
**File:** `CURSOR\_MODE\_REFERENCE\_FOR\_LLM\_PROJECTS.md`  
**Recommended path:** `claude-knowledge/universal/CURSOR\_MODE\_REFERENCE\_FOR\_LLM\_PROJECTS.md`  
...
```txt
https://raw.githubusercontent.com/wietsmarais/main/docs/process/NIKARI\_CURSOR\_OPERATING\_ROLES.md
```

Reusable Cursor operating-mode starter prompts:

```txt
https://raw.githubusercontent.com/cursor-prompts/main/prompts/governance/J-cursor-operating-modes.md
```

Structured writing / manuscript addendum, where relevant:

```txt
https://raw.githubusercontent.com/wietsmarais/main/docs/process/NIKARI\_CURSOR\_MANUSCRIPT\_MODE.md
```
...
```txt
https://raw.githubusercontent.com/wietsmarais/wietsmarais/main/docs/process/NIKARI\_CURSOR\_MANUSCRIPT\_MODE.md
```
...
https://raw.githubusercontent.com/wietsmarais/wietsmarais/main/docs/process/NIKARI\_CURSOR\_OPERATING\_ROLES.md
